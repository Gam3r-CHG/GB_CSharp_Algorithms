namespace Algorithms
{
    ...
    internal class SearchTest
    {
        ...
        public static int SimpleFind(int[] array, int searchValue) //поиск элемента с определенным значением
        {
            for (int i = 0; i < array.Length; i++)
            {
                if (array[i] == searchValue) { return i; }
            }
            return -1;  // Если в массиве элемент не найден
        }
        ...
        /// <param name="searchValue">Значение для поиска</param>
        /// <returns>Индекс найденного элемента массива или -1 если ничего не найдено</returns>
        public static long BinarySearch(int[] array, int searchValue)
        {
            ...
            while (min <= max)
            {
                ...
                if (searchValue == array[mid]) { return mid; }          // Если нашли 
        ...
        /// <param name="searchValue">Значение для поиска</param>
        /// <returns>Индекс найденного элемента массива или -1 если ничего не найдено</returns>
        public static long InterpolationSearch(int[] array, int length, int searchValue)
        {
            ...
            while (min <= max)
            {
                ...
                if (array[mid] == searchValue) { return mid; }          // Если "угадали"
            ...
            return -1; // Если элемент в массиве не найден
